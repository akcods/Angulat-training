...
export class ProductFormComponent implements OnInit {
  ...
  myForm;
  buttonString:string;
  constructor(public fb:FormBuilder,private ps:ProductService,  public dialogRef: MatDialogRef<ProductFormComponent>,@Optional() @Inject(MAT_DIALOG_DATA) public data:any) {
  //  console.log(data)
   if(data==null){
